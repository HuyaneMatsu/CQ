...
def createdocument():
    ...
    write('.view .mimiarea .mimi{background-color: #ffcc00;border: None;border-top-left-radius: 10px;border-top-right-radius: 10px;color: #3e1727;cursor: pointer;float: right;font: 550 16px Arial;height:34px;text-align: center;text-decoration: none;text-shadow: -1px -1px 1px #ff8d8d14, -1px 1px 1px #ff8d8d14, 1px -1px 1px #ff8d8d14, 1px 1px 1px #ff8d8d14;outline: 0;white-space: nowrap;width: 100%;}')
    ...
    write('.index_page .mimiarea{display: block; float: right; width: 210px;height: calc(100vh - 54px);overflow: auto;}')
